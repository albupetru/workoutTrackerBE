...
namespace workoutTracker.Domain.Migrations
{
    ...
    [Migration("20260323143525_SeedExerciseDescriptionsAndInstructions")]
    partial class SeedExerciseDescriptionsAndInstructions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("workoutTracker.Domain.Models.Application.Exercise", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTimeOffset(new DateTime(2026, 3, 23, 16, 35, 25, 126, DateTimeKind.Unspecified).AddTicks(2281), new TimeSpan(0, 2, 0, 0, 0)),
                            ...
                            ModifiedOn = new DateTimeOffset(new DateTime(2026, 3, 23, 16, 35, 25, 126, DateTimeKind.Unspecified).AddTicks(2281), new TimeSpan(0, 2, 0, 0, 0)),
                            Name = "Bench Press (Paused)",
                            VerifiedById = new Guid("5b3e3f65-ef2f-4646-b4d0-5f3e312bdd5e"),
                            VerifiedOn = new DateTimeOffset(new DateTime(2026, 3, 23, 16, 35, 25, 126, DateTimeKind.Unspecified).AddTicks(2281), new TimeSpan(0, 2, 0, 0, 0))
                        },
                        new
                        {
            ...
            modelBuilder.Entity("workoutTracker.Domain.Models.Application.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedById = new Guid("5b3e3f65-ef2f-4646-b4d0-5f3e312bdd5e"),
                            CreatedOn = new DateTimeOffset(new DateTime(2026, 3, 23, 16, 35, 25, 132, DateTimeKind.Unspecified).AddTicks(399), new TimeSpan(0, 2, 0, 0, 0)),
                            Email = "",
                            GoogleId = "",
                            ModifiedById = new Guid("5b3e3f65-ef2f-4646-b4d0-5f3e312bdd5e"),
                            ModifiedOn = new DateTimeOffset(new DateTime(2026, 3, 23, 16, 35, 25, 132, DateTimeKind.Unspecified).AddTicks(399), new TimeSpan(0, 2, 0, 0, 0)),

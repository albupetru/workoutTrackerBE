...
namespace workoutTracker.Domain.Migrations
{
    ...
    [Migration("20260321202707_AddRoleAndUserRoleSupport")]
    partial class AddRoleAndUserRoleSupport
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("workoutTracker.Domain.Models.Application.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTimeOffset(new DateTime(2026, 3, 21, 22, 27, 6, 819, DateTimeKind.Unspecified).AddTicks(8015), new TimeSpan(0, 2, 0, 0, 0)),
                            Email = "",
                            GoogleId = "",
                            ModifiedById = new Guid("5b3e3f65-ef2f-4646-b4d0-5f3e312bdd5e"),
                            ModifiedOn = new DateTimeOffset(new DateTime(2026, 3, 21, 22, 27, 6, 819, DateTimeKind.Unspecified).AddTicks(8015), new TimeSpan(0, 2, 0, 0, 0)),
